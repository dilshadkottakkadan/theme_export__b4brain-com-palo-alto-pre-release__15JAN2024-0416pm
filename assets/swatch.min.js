...
!(function ($) {
    ...
    var items = document.getElementsByClassName("attr_pa_metafields_tornado_");
              var t = e.data("value");
              $( ".attr_pa_metafields_tornado_" ).css('display','none');
              $('.'+ t).css('display','flex');
                                    ...
                                    (function () {
                                        if (window.ShopifyAnalytics && window.ShopifyAnalytics.lib && window.ShopifyAnalytics.lib.track) {
                                            var t = o[0].getBoundingClientRect().top <= window.innerHeight,
                                                e = n;
                                            window.ShopifyAnalytics.lib.track("Product Recommendations Displayed", { theme: "Bmax", didPageJumpOccur: t, numberOfRecommendationsDisplayed: e });
                                        }
                                    })(),
                                geckoShopify.review(),
                                geckoShopify.lazyWishUpdate();
